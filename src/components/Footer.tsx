...
export function Footer() {
  ...
  return (
    <footer role="contentinfo" className="bg-[#2B1D16] text-[#F7F3EC] dark:bg-[#0d0b09] dark:text-[#f5f5f4] pt-20 pb-8 px-6 mt-20 overflow-hidden">
      <motion.div 
        className="max-w-7xl mx-auto mb-20 bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-10"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <motion.div className="space-y-6" variants={footerItemVariants}>
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/colabcoffeecalcutta/" target="_blank" rel="noopener noreferrer" aria-label="Follow CoLab Coffee Calcutta on Instagram" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-[#2B1D16] dark:hover:text-black transition-colors">
              <Instagram size={20} />
            </a>
          </div>
        </motion.div>
        ...
        <motion.div className="space-y-6" variants={footerItemVariants}>
          <h4 className="font-serif text-lg tracking-wide uppercase text-white/50 text-sm">{t('footer.visitHeader')}</h4>
        ...
        <motion.div className="space-y-6" variants={footerItemVariants}>
          <h4 className="font-serif text-lg tracking-wide uppercase text-white/50 text-sm">{t('footer.hoursHeader')}</h4>
          ...
          <div className="flex gap-3 pt-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-xs border border-white/10">
              {t('features.lgbtq')}
            </span>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-xs border border-white/10">
      ...
      <motion.div 
        className="max-w-7xl mx-auto border-t border-white/10 mt-16 pt-8 flex flex-col items-center justify-center gap-4 text-xs text-white/40"
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <a href="/admin" className="hover:text-white/80 underline decoration-white/20 underline-offset-4">Admin Login</a>
      </motion.div>
    </footer>
  );
}
